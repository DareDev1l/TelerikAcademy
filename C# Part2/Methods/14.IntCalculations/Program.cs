...
class IntegerCalculations
{
    static void Main()
    {
        ...
        int[] setOfIntegers = InputArray(n);
        Console.WriteLine("Min: {0}", Min(setOfIntegers));
        Console.WriteLine("Max: {0}", Max(setOfIntegers));
        Console.WriteLine("Average: {0}", AverageSum(setOfIntegers));
        Console.WriteLine("Sum: {0}", Sum(setOfIntegers));
        Console.WriteLine("Product: {0}\n", Product(setOfIntegers));
    }
